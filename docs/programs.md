...
Receipt kinds, delegation scope bits, PDA seeds, task statuses, and protocol
errors are defined in
[`crates/trust_substrate_core/src/constants.rs`](../crates/trust_substrate_core/src/constants.rs)
and
[`crates/trust_substrate_core/src/error.rs`](../crates/trust_substrate_core/src/error.rs).
Keep those files authoritative instead of copying the lists here.
