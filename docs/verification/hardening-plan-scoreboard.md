...
| W0 | W0.5 replace `init_if_needed` with explicit guards | complete | `programs/agent_stake/src/instructions/slash.rs`, `programs/reputation_accumulator/src/instructions/apply_reputation_receipt.rs`, `programs/task_registry/src/instructions/sync_task_status.rs` | |
