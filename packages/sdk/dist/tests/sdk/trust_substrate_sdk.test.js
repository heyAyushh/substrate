...
import { ReceiptLedger, TrustSubstrateClient, createAuthorityRotationEvent, createMerkleTree, deriveReputation, verifyMerkleProof, } from "../../packages/sdk/src/index.js";
...
test("derives deterministic reputation from verified history", () => {
    ...
    strictEqual(reputationA.domains.coordination, reputationB.domains.coordination);
...
test("models authority rotation with sdk identity helpers", () => {
    ...
    strictEqual(finalized.identity.authority, "Authority2222222222222222222222222222222222");
...
test("models emergency guardian rotation with sdk identity helpers", () => {
    ...
    strictEqual(finalized.identity.authority, "Authority9999999999999999999999999999999999");
...
test("rejects emergency rotation approvals that do not satisfy guardian policy", () => {
    ...
    throws(() => client.identity.emergencyRotateAuthority({
        identity,
        guardianSet,
