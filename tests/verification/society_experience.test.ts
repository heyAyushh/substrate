...
test("mission-first onboarding never blocks entry", () => {
  ...
  strictEqual(waitingModel.primaryActionLabel, "Enter live board");
  ...
  strictEqual(resolvedModel.primaryActionLabel, "Enter live board");
...
test("mission-first onboarding can explain events from any live agent", () => {
  ...
  strictEqual(model.primaryActionLabel, "Enter live board");
